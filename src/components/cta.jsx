    ...
    return (
        <div className="flex flex-col lg:flex-row m-10">
            ...
            <div className="flex-1 mb:flex-none bg-teal-600/70 text-white p-8 flex flex-col items-center justify-center rounded-lg drop-shadow-xl m-3 ">
                  <h2 className="text-3xl font-body font-bold mb-4 text-center">Tutta la meditazione che ti serve</h2>
        <p className="mb-6 text-xl text-center justify-center">Scopri i nostri percorsi meditativi, pensati per guidarti verso il tuo <b>equilibrio interiore.</b> 
         ...
         <a href="/meditazione" className="drop-shadow-xl bg-yellow-500 text-teal-700 px-8 py-3 text-2xl rounded-full font-semibold text-center hover:bg-yellow-100 hover:scale-130 hover:-translate-y-1 transition mt-10">
Scopri i percorsi</a>
                </div>
